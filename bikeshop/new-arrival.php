    ...
    <div class="index-bg-area">
        <div class="new-arrival-section-cont">
          <div class="index-left-text">
            <div class="big-letters"><h2 class="hype-up">NEW</h2> <br> <h2 class="plus-sign">+</h2><h2 class="keep-up">ARRIVALS</h2></div>
          ...
          <div class="index-carousel">
              <div class="carousel-content">  <img class="index-carousel-img" src="https://i.pinimg.com/originals/97/1f/04/971f04c7fc2ab524c12288e3c435763d.jpg" alt=""></div>
              <div class="carousel-content"> <img class="index-carousel-img" src="https://p.vitalmtb.com/photos/press_releases/2292/title_image/s1600_01_06_Tues_AL_grey_seite5b61594508d1a_1920x1168_681627.jpg?1536768732" alt=""></div>
              <div class="carousel-content"> <img class="index-carousel-img" src="https://www.inside-mtb.de/wp-content/uploads/2016/01/yt_tues_2016_6.jpg" alt=""></div>
              <div class="carousel-content"> <img class="index-carousel-img" src="https://s14761.pcdn.co/wp-content/uploads/2016/01/YT-CAPRA-CF-Pro-Race-2016.jpg" alt=""></div>
          </div>
        </div>
      </div>
    </div>
   ...
   <div class="accessories-area">
    <div class="accessories-section">
      <div class="accessories-content">
          ...
          <div class="accessories-display-title"><h2>NEW ARRIVALS</h2></div>
          <!-- <div class="flower" data-id="giant" data-category="giant">test</div>
          <div class="flower" data-id="trinx" data-category="trinx">test</div> -->
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
          ...
          if($product_price > 6000 and $product_price <= 7000){
            $product_price_filter = '6-7k';
          } else if($product_price > 8000 and $product_price <= 9000){
            $product_price_filter = '8-9k';
          } else if($product_price > 10000 and $product_price <= 20000){
            $product_price_filter = '10-20k';
          }  else if($product_price > 20000 and $product_price <= 40000){
            $product_price_filter = '20-40k';
          }  else if($product_price > 40000 and $product_price <= 60000){
            $product_price_filter = '40-60k';
          }  else if($product_price > 60000 and $product_price <= 80000){
            $product_price_filter = '60-80k';
          } else {
            $product_price_filter = '80upk';
          }

          
          echo "<div class='second-cont-display' data-category='$brand_name $product_price_filter'>";
          ...
          echo "<span class='accessories-price'>" . "₱". $row['product_price'] . "</span>";
          echo "</div>";
          echo "</div>";
          echo "</a>";
          echo "</div>";
