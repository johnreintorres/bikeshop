        ...
        if($stmt->rowCount() == 1){
          $row = $stmt->fetch(PDO::FETCH_ASSOC);
                ...
                if(isset($_POST['btn_submit']) && ($_SERVER["REQUEST_METHOD"] == "POST")){
                  ...
                  $param_product_price = $acce_quantity;
                  $param_product_quantity = $acce_quantity;
...
<body>
  ...
  <section>
    <div class="clicked-display-area">
      <div class="clicked-display-section">
        ...
        <div class="main-carousel-content"><img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-transparent-grey-750-ml-74948-301821-1575615385.jpeg" alt=""></div>
        <div class="main-carousel-content"><img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-black-grey-750-ml-74948-301822-1575615385.jpeg" alt=""></div>


        <div class="main-carousel-content"><img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-red-bordeaux-750-ml-74948-301820-1575615385.jpeg" alt=""></div>
        <div class="main-carousel-content"><img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-transparent-grey-750-ml-74948-301821-1575615385.jpeg" alt=""></div>
        <div class="main-carousel-content"><img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-black-grey-750-ml-74948-301822-1575615385.jpeg" alt=""></div>
     ...
     <a href="" data-slide="1"><div class="sub-carousel-content"> <img src="<?php echo $image ?>" alt=""></div></a>
     <a href="" data-slide="2"><div class="sub-carousel-content"> <img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-red-bordeaux-750-ml-74948-301820-1575615385.jpeg" alt=""></div></a>
     <a href="" data-slide="3"><div class="sub-carousel-content"> <img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-transparent-grey-750-ml-74948-301821-1575615385.jpeg" alt=""></div></a>
     <a href="" data-slide="4"><div class="sub-carousel-content"> <img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-black-grey-750-ml-74948-301822-1575615385.jpeg" alt=""></div></a>
      </div>
      </div>
        </div>
      ...
      <div class="clicked-right-area">
        <div class="product-details-area">
                ...
                <div class="left-clicked-text">
                  ...
                  <span class="clicked-model-subtitle"><?php echo $row["content"] ?></span>
                  <h2 class="clicked-model-price">₱<?php echo $row["acce_price"] ?></h2>
                ...
                <div class="clicked-color-carousel-area">
                  <div class="clicked-color-carousel-title"><span class="colors-title">Colors</span></div>
                    ...
                    <a href="" data-slide="5"><div class="clicked-color-content1" style="background-color: <?php echo $row["color1"] ?>"></div></a>
                    <a href="" data-slide="6"><div class="clicked-color-content2" style="background-color: black;"></div></a>
                    <a href="" data-slide="7"><div class="clicked-color-content3" style="background-color: <?php echo $row["color3"] ?>"></div></a>
                    <a href="" data-slide="8"><div class="clicked-color-content3" style="background-color: <?php echo $row["color3"] ?>"></div></a>
                    </div>  
                    </div>
                ...
                <div class="clicked-desc-content">
                    <p class="desc-content-p"><?php echo $row["acce_desc"] ?></p>
                </div>
                  </div>
                  </div>
        </div>
  ...
  <section>
    ...
    <div class="news-events-header">
      ...
      <div class="specs-content"><h2>Color: </h2> <span><?php echo $row["color1"] ?>,<?php echo $row["color2"] ?>,<?php echo $row["color3"] ?>,<?php echo $row["color3"] ?></span></div>
      <div class="specs-content"><h2>Material :</h2><span><?php echo $row["material"] ?></span></div>
      <div class="specs-content"><h2>Weight : </h2><span><?php echo $row["weight"] ?></span></div>
      <div class="specs-content"><h2>Diameter :</h2><span><?php echo $row["diameter"] ?></span></div>
      <div class="specs-content"><h2>Depth : </h2><span><?php echo $row["depth"] ?></span></div>
      </div>
</div>
      </div>
    </div>
    ...
    <div class="supplier-index-header">
      ...
      <div class="related-section">
          ...
          <div class="sale-content-container">
            <img src="https://www.bike-components.de/cache/p/xl1/7/4/Elite-Fly-Bottle-750-ml-2020-Model-red-bordeaux-750-ml-74948-301820-1575615385.jpeg" alt="">
