        ...
        if($stmt->rowCount() == 1){
          $row = $stmt->fetch(PDO::FETCH_ASSOC);
                ...
                if(isset($_POST['btn_submit']) && ($_SERVER["REQUEST_METHOD"] == "POST")){
                  ...
                  $param_product_price = $parts_price;
                  $param_product_quantity = $parts_quantity;
      ...
      <div class="clicked-right-area">
        <div class="product-details-area">
                ...
                <div class="left-clicked-text">
                  ...
                  <h2 class="clicked-model-price">₱<?php echo $row["parts_price"] ?></h2>
                ...
                <div class="clicked-desc-content">
                    <p class="desc-content-p"><?php echo $row["parts_desc"] ?></p>
                </div>
                  </div>
                  </div>
        </div>
