...
<header>
  <div class="arrival-header-area">
    <div class="admin-arrival-bg-area">
      <h2>NEW ARRIVALS</h2>
    </div>
  </div>
</header>
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
          ...
          echo "<a href='update-arrival.php?id=". $row['id'] ."' class='data-btn'>Update</a>";
          echo "<a href='delete-arrival.php?id=". $row['id'] ."'class='data-btn'>Delete</a>";
          echo "</div>";
          echo "</div>";
        }
...
?>   
       ...
       <div class="add-new-btn"><a class="add-new-link" href="add-arrival.php">Add new product</a></div> 
      </div>
    </div>
   </div>
   </div>
